...
class MessageBubble extends StatelessWidget {
  ...
  /// Whether this is a user message (affects positioning and styling)
  final bool isUser;
  ...
  /// Custom content widget (overrides text)
  ...
  Widget build(BuildContext context) {
    ...
    final effectiveConfig = _getEffectiveConfig(theme);
    ...
    Widget bubble = Container(
      ...
      child: Column(
        ...
        children: [
          ...
          if (!isUser && effectiveConfig.showAvatar)
            _buildSenderInfo(context, effectiveConfig),

          // Message content
          _buildMessageContent(context, effectiveConfig),
          ...
          // Timestamp
          if (effectiveConfig.showTimestamp && timestamp != null)
    ...
    if (animated && animationDuration != null) {
      return _wrapWithAnimation(bubble);
    }

    return bubble;
  }

  MessageBubbleConfig _getEffectiveConfig(ThemeData theme) {
  ...
  Widget _buildMessageContent(BuildContext context, MessageBubbleConfig config) {
    return Row(
