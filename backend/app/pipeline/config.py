...
class ChunkingOptions(BaseModel):
    ...
    enable_semantic_chunking: Optional[bool] = Field(None, description="Override semantic chunking setting. If not specified, uses preset's default. True=semantic boundaries with embeddings, False=sentence splitting.")
